...
## CP-22 exit checklist

- [x] Mana-base planning has a stable versioned contract.
- [x] Colorless through five-color identities produce exact 37-land plans.
- [x] Only legal identity basics are named; nonbasic fixing and utility choices remain visible slots.
- [x] Duplicate or reordered color identities cannot change the plan.
- [x] Full coverage distinguishes structural slots from named cards.
...
## CP-24 exit checklist

- [x] Nonbasic selection has a stable versioned contract and deterministic ordering.
- [x] Only inspected legal land options can be selected.
- [x] Singleton identity and fixing/utility slot capacities are enforced.
- [x] Named source counts combine planned basics with selected nonbasics.
- [x] Source results expose demand, count, and presence without an unsupported probability claim.
...
## CP-25 exit checklist

- [x] Colored-source targets have a stable versioned contract.
- [x] Exact hypergeometric probabilities expose deck, draw, and target assumptions.
- [x] The hardest selected-card pip requirement is reported per identity color.
- [x] Available named sources are compared with turn-aware targets.
- [x] Land options expose deterministic fixing, utility, tapped-text, and color-production evidence.
